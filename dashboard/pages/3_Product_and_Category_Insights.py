...
st.markdown("""
This page explores product performance, category trends, and regional influences on product sales and categories.  
Understand the trends in product performance and category distribution in the market.
